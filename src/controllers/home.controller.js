...
router.get("/dresses/view_product/:id", async(req,res)=>{
    try{
...
// router.get("/dresses/checkout/:id" ,async(req,res)=>{
//     try{
...
router.get("/dresses/payment/:id", async(req,res)=>{
    try{
...
// -------------------------------------gapfit controller-----------------------------------------------
// router.post("/gapfit",async(req,res)=>{
//     try{
//         const gapfit=await Gapfit.create(req.body);
//         return res.send(gapfit)
//     }catch(err){
//         return res.status(500).send(err.message)
//     }
// })
